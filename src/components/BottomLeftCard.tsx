  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <span className="text-2xl md:text-3xl font-bold font-poppins text-[#1E293B] tracking-tight">
          1.2K+
        </span>
        <span className="text-[10px] md:text-[11px] font-medium text-[#64748B] uppercase tracking-widest">
          Spaces Styled
        </span>
      </div>
      ...
      >
        <div className="bg-slate-100 p-1 rounded-full flex items-center justify-center">
