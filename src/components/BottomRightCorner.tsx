  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <span className="text-[16px] md:text-[20px] font-bold font-poppins text-[#1E293B]">
          The Lookbook
        </span>
        <div className="flex items-center gap-1 text-[#64748B] cursor-pointer hover:text-[#1E293B] transition-colors">
          <span className="text-[12px] md:text-[15px] font-medium uppercase tracking-widest">Explore Pieces</span>
          <ChevronRight className="w-3.5 h-3.5 md:w-4 md:h-4 text-[#64748B] hover:text-[#1E293B]" />
        </div>
      </div>
    </motion.div>
  )
